 ...
 */
/*.string.*/ function is_email_statustext($is_email_status) {
	switch ($is_email_status) {
		...
		case ISEMAIL_DOMAINNOTFOUND:		return 'Couldn\'t find an MX record for this domain';								break;	// 151
		case ISEMAIL_BADPARAMETER:		return 'Unrecognised parameter';										break;	// 254
		default:				return 'Undefined error';												// 255 and others
	}
}
?>